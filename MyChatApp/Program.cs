...
builder.Services.AddSqliteCollection<string, IngestedChunk>("data-mychatapp-chunks", vectorStoreConnectionString);
builder.Services.AddSqliteCollection<string, IngestedDocument>("data-mychatapp-documents", vectorStoreConnectionString);
